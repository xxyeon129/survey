      ...
      if (uploadedFileValue) {
        ...
        reader.onload = (file) => {
          ...
          if (result) {
            ...
            const survey06NMS_sheetName = workbook.SheetNames[5];
            ...
            const survey07PDQ_sheetName = workbook.SheetNames[6];
            ...
            const survey08PDSS_sheetName = workbook.SheetNames[7];
            ...
            const survey09Tired_sheetName = workbook.SheetNames[8];
            ...
            const survey10SCOPA_sheetName = workbook.SheetNames[9];
            ...
            const survey11Constipation_sheetName = workbook.SheetNames[10];
            ...
            const survey12Food_sheetName = workbook.SheetNames[11];
